...
* Copy or rename the module directory to codeplayground.
* Replace all occurances of codeplayground in files with the new name for your question type.
* Rename files that have codeplayground replacing codeplayground with the new name for your question type.
