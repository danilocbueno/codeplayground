      ...
      <div class="cp_wrapper">
        <div class="cp_editor">
          <div class="cp_tab_links">
            <label data-tabid="cp_tab_html" class="cp_tab_btn active">
              <span class="cpicon cpicon-html"></span>
              index.html
            </label>
            <label data-tabid="cp_tab_css" class="cp_tab_btn">
              <span class="cpicon cpicon-css"></span>
              style.css
            </label>
            <label
            ...
            >
              <span class="cpicon cpicon-javascript"></span>
              script.js
            </label>
            ...
            <a class="cp_tab_toggle_wrap cp_tab_btn_conf">
              <svg
                class="wrap_on cp_show"
                xmlns="http://www.w3.org/2000/svg"
                height="24"
                width="24"
              >
                <path
                  d="M14.7 20.35 11.35 17l3.35-3.35 1.05 1.075-1.525 1.525h3.025q.825 0 1.413-.588.587-.587.587-1.412t-.587-1.413q-.588-.587-1.413-.587h-13v-1.5h13q1.45 0 2.475 1.025Q20.75 12.8 20.75 14.25q0 1.45-1.025 2.475Q18.7 17.75 17.25 17.75h-3.025l1.525 1.525Zm-10.45-2.6v-1.5h4.5v1.5Zm0-11v-1.5h15.5v1.5Z"
                />
              </svg>

              <svg
                class="wrap_off cp_hide"
                xmlns="http://www.w3.org/2000/svg"
                height="24"
                width="24"
              >
                <path
                  d="M3.25 17.625v-1.5h11.5v1.5Zm0-4.875v-1.5h17.5v1.5Zm0-4.875v-1.5h17.5v1.5Z"
                />
              </svg>
            </a>
          </div>
...
$currentanswerJS</textarea
        ...
        <div class="browser-mockup">
          ...
          <iframe class="cp_preview"> </iframe>
        </div>
      </div>
...
EOF;
  ...
  public function buildTests($qa)
  {
    ...
    $result = <<<EOF
        ...
        <!--CONF Testes -->
        <input type="hidden" id="tests_results" name="$answerTestResult">
        ...
        window.addEventListener("DOMContentLoaded", function () {
          ...
          const _document = document.querySelector(".cp_preview").contentWindow.document;
          ...
          function MyReporter(runner) {
            ...
            runner.on("pass", function (test) {
              report.passes.push(test.fullTitle());
            });
            ...
            runner.on("end", function () {
              report.total = report.passes.length + report.fail.length;
              report.score = report.passes.length / report.total;
              console.log(report);
      
              //save data to form
              let testResultsForm = document.querySelector('#tests_results');
              if(testResultsForm) {
                testResultsForm.value = JSON.stringify(report);
              }
